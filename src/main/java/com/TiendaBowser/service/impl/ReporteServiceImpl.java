        ...
        try {
            ...
            switch (tipo) {
                ...
                case "Xls" -> {
                    ...
                    configuracion.setCollapseRowSpan(Boolean.FALSE);
            ...
            return ResponseEntity.ok().headers(header).contentType(mediaType).body(new InputStreamResource(new ByteArrayInputStream(data)));
